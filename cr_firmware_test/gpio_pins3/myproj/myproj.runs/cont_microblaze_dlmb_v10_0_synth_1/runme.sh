...
HD_PWD='/home/kplant/lwa_firmware/gpio_pins3/myproj/myproj.runs/cont_microblaze_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cont_microblaze_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cont_microblaze_dlmb_v10_0.tcl
