...
ISEStep( "vivado",
         "-log cont_microblaze_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cont_microblaze_ilmb_bram_if_cntlr_0.tcl" );
