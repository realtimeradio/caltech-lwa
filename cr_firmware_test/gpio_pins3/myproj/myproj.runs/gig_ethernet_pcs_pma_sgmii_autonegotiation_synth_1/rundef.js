...
ISEStep( "vivado",
         "-log gig_ethernet_pcs_pma_sgmii_autonegotiation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gig_ethernet_pcs_pma_sgmii_autonegotiation.tcl" );
