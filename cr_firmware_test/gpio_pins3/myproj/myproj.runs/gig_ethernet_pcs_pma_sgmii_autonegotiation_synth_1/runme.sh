...
HD_PWD='/home/kplant/lwa_firmware/gpio_pins3/myproj/myproj.runs/gig_ethernet_pcs_pma_sgmii_autonegotiation_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gig_ethernet_pcs_pma_sgmii_autonegotiation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gig_ethernet_pcs_pma_sgmii_autonegotiation.tcl
