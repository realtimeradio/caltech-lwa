...
ISEStep( "vivado",
         "-log cont_microblaze_axi_slave_wishbone_classic_master_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cont_microblaze_axi_slave_wishbone_classic_master_0_0.tcl" );
