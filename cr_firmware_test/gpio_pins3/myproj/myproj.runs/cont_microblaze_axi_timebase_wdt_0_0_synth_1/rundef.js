...
ISEStep( "vivado",
         "-log cont_microblaze_axi_timebase_wdt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cont_microblaze_axi_timebase_wdt_0_0.tcl" );
