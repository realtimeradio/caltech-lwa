...
parser.add_argument('datadir',type=str,help='path to the directory where the data should go')
    ...
    while(True):
        try:
            ...
            if pkt_index == 64:  #end of the snpshot
                ...
                np.save(datadir+'/single_board_snapshot' + str(time.time())+'_'+str(board_id)+'_'+str(this_board_triggered),single_board_snapshot) #save the burst
