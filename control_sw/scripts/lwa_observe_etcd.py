...
def configure_snaps(snapids, config_file, program=True):
...
def main():
    ...
    parser.add_argument('--skipprog', dest='skipprog', action='store_true',
                        help ='Use this flag to skip programming and ADC link training')
    args = parser.parse_args()

    if args.initsnaps:
        configure_snaps(map(int, args.snapids.split(',')), args.configfile, program=not args.skipprog)
